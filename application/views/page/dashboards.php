...
<body>
	...
	<header id="home">
		<!-- Background Image -->
		<div class="bg-img" style="background-image: url('<?php echo base_url();?>creative/img/background1.jpg');">
				...
				<div class="navbar-header">
					...
					<div class="navbar-brand">
						<a href="index.html">
							...
							<img class="logo-alt" src="<?php echo base_url();?>creative/img/logo-alt.png" alt="logo">
						</a>
					</div>
					<!-- /Logo -->
			...
			<div class="row">
				...
				<div class="col-md-4 col-xs-6 work">
					...
					<div class="work-content">
						...
						<div class="work-link">
							<a href="#"><i class="fa fa-external-link"></i></a>
							<a class="lightbox" href="<?php echo base_url();?>creative/img/work2.jpg"><i class="fa fa-search"></i></a>
						</div>
					</div>
				</div>
				<!-- /Work -->
				...
				<!-- Work -->
				<div class="col-md-4 col-xs-6 work">
					<img class="img-responsive" src="<?php echo base_url();?>creative/img/work3.jpg" alt="">
					<div class="overlay"></div>
					<div class="work-content">
						<span>Category</span>
						<h3>Lorem ipsum dolor</h3>
						<div class="work-link">
							<a href="#"><i class="fa fa-external-link"></i></a>
							<a class="lightbox" href="<?php echo base_url();?>creative/img/work3.jpg"><i class="fa fa-search"></i></a>
						</div>
					</div>
				</div>
				<!-- /Work -->
				...
				<!-- Work -->
				<div class="col-md-4 col-xs-6 work">
					<img class="img-responsive" src="<?php echo base_url();?>creative/img/work4.jpg" alt="">
					<div class="overlay"></div>
					<div class="work-content">
						<span>Category</span>
						<h3>Lorem ipsum dolor</h3>
						<div class="work-link">
							<a href="#"><i class="fa fa-external-link"></i></a>
							<a class="lightbox" href="<?php echo base_url();?>creative/img/work4.jpg"><i class="fa fa-search"></i></a>
						</div>
					</div>
				</div>
				<!-- /Work -->
				...
				<!-- Work -->
				<div class="col-md-4 col-xs-6 work">
					<img class="img-responsive" src="<?php echo base_url();?>creative/img/work5.jpg" alt="">
					<div class="overlay"></div>
					<div class="work-content">
						<span>Category</span>
						<h3>Lorem ipsum dolor</h3>
						<div class="work-link">
							<a href="#"><i class="fa fa-external-link"></i></a>
							<a class="lightbox" href="<?php echo base_url();?>creative/img/work5.jpg"><i class="fa fa-search"></i></a>
						</div>
					</div>
				</div>
				<!-- /Work -->
				...
				<!-- Work -->
				<div class="col-md-4 col-xs-6 work">
					<img class="img-responsive" src="<?php echo base_url();?>creative/img/work6.jpg" alt="">
					<div class="overlay"></div>
					<div class="work-content">
						<span>Category</span>
						<h3>Lorem ipsum dolor</h3>
						<div class="work-link">
							<a href="#"><i class="fa fa-external-link"></i></a>
							<a class="lightbox" href="<?php echo base_url();?>creative/img/work6.jpg"><i class="fa fa-search"></i></a>
						</div>
					</div>
				</div>
				<!-- /Work -->
			...
			<div class="row">
				...
				<div class="col-md-6">
					<div id="about-slider" class="owl-carousel owl-theme">
						<img class="img-responsive" src="<?php echo base_url();?>creative/img/about1.jpg" alt="">
						<img class="img-responsive" src="<?php echo base_url();?>creative/img/about2.jpg" alt="">
						<img class="img-responsive" src="<?php echo base_url();?>creative/img/about1.jpg" alt="">
						<img class="img-responsive" src="<?php echo base_url();?>creative/img/about2.jpg" alt="">
					</div>
				</div>
	...
	<div id="numbers" class="section sm-padding">
		...
		<!-- Background Image -->
		<div class="bg-img" style="background-image: url('<?php echo base_url();?>creative/img/background2.jpg');">
			<div class="overlay"></div>
		</div>
		<!-- /Background Image -->
	...
	<div id="testimonial" class="section md-padding">
		...
		<!-- Background Image -->
		<div class="bg-img" style="background-image: url('<?php echo base_url();?>creative/img/background3.jpg');">
			<div class="overlay"></div>
		</div>
		<!-- /Background Image -->
			...
			<div class="row">
				...
				<div class="col-md-10 col-md-offset-1">
					<div id="testimonial-slider" class="owl-carousel owl-theme">
						...
						<div class="testimonial">
							<div class="testimonial-meta">
								<img src="<?php echo base_url();?>creative/img/perso2.jpg" alt="">
								<h3 class="white-text">John Doe</h3>
								<span>Web Designer</span>
							</div>
							<p class="white-text">Molestie at elementum eu facilisis sed odio. Scelerisque in dictum non consectetur a erat. Aliquam id diam maecenas ultricies mi eget mauris.</p>
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-sm-4">
					<div class="team">
						<div class="team-img">
							<img class="img-responsive" src="<?php echo base_url();?>creative/img/team1.jpg" alt="">
							<div class="overlay">
				...
				<div class="col-sm-4">
					<div class="team">
						<div class="team-img">
							<img class="img-responsive" src="<?php echo base_url();?>creative/img/team2.jpg" alt="">
							<div class="overlay">
								<div class="team-social">
									<a href="#"><i class="fa fa-facebook"></i></a>
									<a href="#"><i class="fa fa-google-plus"></i></a>
				...
				<div class="col-sm-4">
					<div class="team">
						<div class="team-img">
							<img class="img-responsive" src="<?php echo base_url();?>creative/img/team3.jpg" alt="">
							<div class="overlay">
								<div class="team-social">
									<a href="#"><i class="fa fa-facebook"></i></a>
									<a href="#"><i class="fa fa-google-plus"></i></a>
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-md-4">
					<div class="blog">
						<div class="blog-img">
							<img class="img-responsive" src="<?php echo base_url();?>creative/img/blog2.jpg" alt="">
						</div>
						<div class="blog-content">
							<ul class="blog-meta">
								<li><i class="fa fa-user"></i>John doe</li>
							...
							<h3>Molestie at elementum eu facilisis sed odio</h3>
							<p>Nec feugiat nisl pretium fusce id velit ut tortor pretium. Nisl purus in mollis nunc sed. Nunc non blandit massa enim nec.</p>
							<a href="<?php echo base_url();?>creative/blog-single.html">Read more</a>
						</div>
					</div>
				</div>
				<!-- /blog -->
				...
				<div class="col-md-4">
					<div class="blog">
						<div class="blog-img">
							<img class="img-responsive"  src="<?php echo base_url();?>creative/img/blog3.jpg" alt="">
						</div>
						<div class="blog-content">
							<ul class="blog-meta">
								<li><i class="fa fa-user"></i>John doe</li>
